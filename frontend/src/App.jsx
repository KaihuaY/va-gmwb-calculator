    ...
    <div className="flex h-screen overflow-hidden bg-slate-50">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <div className="flex-1 overflow-y-auto p-6">
          ...
          <ResultsSummary results={results} running={running} progress={progress} />
          ...
          {activeTab === 'charts' && results && (
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                ...
                <FeeVsClaimChart claimStats={results.claim_stats} feeStats={results.fee_stats} />
              </div>
            </div>
          )}
          ...
          {activeTab === 'charts' && results && (
            <div className="mt-4 grid grid-cols-1 lg:grid-cols-3 gap-4">
              {[
                { title: 'PV(Claims) Statistics', stats: results.claim_stats },
                    ...
                    <tbody>
                      {Object.entries(stats).map(([k, v]) => (
                        <tr key={k} className="border-b border-slate-50">
                          <td className="py-1 text-slate-500 capitalize">{k.replace('_', ' ')}</td>
